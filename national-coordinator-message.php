...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h1 class="text-center">NATIONAL COORDINATOR MESSAGE</h1>
                                    <div class="breadcrumb-bar">
                                        <ul class="breadcrumb text-center">
                                            <li><a href="index.php">Home</a></li>
                                            <li>National Coordinator Message</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
				...
				$userQuery = "select * from informative where informativeid='108' && status='active'";
