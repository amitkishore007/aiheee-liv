...
if ($is_imgName!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName='$imgName',Add_title='$Add_title' where cityid='$cityid'";
}
elseif ($is_imgName2!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName2='$imgName2',Add_title='$Add_title' where cityid='$cityid'";
}
elseif ($is_imgName3!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName3='$imgName3',,Add_title='$Add_title' where cityid='$cityid'";
}
elseif ($is_imgName4!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName4='$imgName4',Add_title='$Add_title' where cityid='$cityid'";
}

elseif ($is_imgName5!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName5='$imgName5',Add_title='$Add_title' where cityid='$cityid'";
}




/*if ($is_imgName!='0' OR $is_imgName2!='0' OR $is_imgName3!='0' OR $is_imgName4!='0' OR $is_imgName5!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName='$imgName',imgName2='$imgName2',imgName3='$imgName3',imgName4='$imgName4',imgName5='$imgName5',PetAllowed='$petallowed',FitnessCentre='$FitnessCentre', Restaurant='$Restaurant', GroupAllowed= '$Groupallowed' , Parking= '$Parking' ,TV= '$TV' , SwimmingPool= '$Swimmimg' , FreeWiFi= '$Freewifi' ,Add_title='$Add_title' where cityid='$cityid'";
}*/
/*
elseif ($is_imgName!='0') 
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',imgName='$imgName',PetAllowed='$petallowed',FitnessCentre='$FitnessCentre', Restaurant='$Restaurant', GroupAllowed= '$Groupallowed' , Parking= '$Parking' ,Add_title='$Add_title' where cityid='$cityid'";
}
...
{
$adminQuery = "update city set heading = '$heading',Key_word = '$Key_word',Description = '$Description', numbering = '$numbering', priority = '$priority', status = '$status', detail ='$detail',Add_title='$Add_title' where cityid='$cityid'";
}
//echo $adminQuery;
//exit();
