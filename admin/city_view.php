        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">             
          <tr>
		   <!-- <td width="15%" align="left" valign="middle" bgcolor="#999999" class="style10"> Image </td>-->
			<td width="19%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Email</td>
			...
			<td width="15%" height="22" align="left" valign="middle" bgcolor="#999999" class="style10">Phone Number</td>
...
<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($userRow['Add_title'])?></span></td>
...
<td align="left"><span class="label label-info pull-center"><?php echo stripslashes($userRow['detail'])?></span></td>
