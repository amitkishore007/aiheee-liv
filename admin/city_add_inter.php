...
/*$petallowed = (mysql_escape_string($_REQUEST['Pet Allowed']) && $_POST['Pet Allowed']  ? $_POST['Pet Allowed'] : "";
$FitnessCentre = isset($_POST['Fitness Centre']) && $_POST['Fitness Centre']  ? $_POST['Fitness Centre'] : "";
$Restaurant = isset($_POST['Restaurant']) && $_POST['Restaurant']  ? $_POST['Restaurant'] : "";
$Tourguides = isset($_POST['Tours Guides']) && $_POST['Tours Guides']  ? $_POST['Tours Guides'] : "";
$Groupallowed = isset($_POST['Group Allowed']) && $_POST['Group Allowed']  ? $_POST['Group Allowed'] : "";
$Parking = isset($_POST['Parking']) && $_POST['Parking']  ? $_POST['Parking'] : "";*/
//$GYM = isset($_POST['GYM']) && $_POST['GYM']  ? $_POST['GYM'] : "";
