...
/*if($category_Id!='')
{
	$where_Query = "WHERE categoryid = $category_Id ORDER BY categoryid asc,subcategoryid asc,subsubcategoryid asc, numbering asc ";

}else
{
	$where_Query = "numbering asc ";
...
?>
<html>
<title>Control Panel : Orissa Holidays</title>
...
<table width="95%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#03617C" bgcolor="#FFFFFF">
  <tr>
    <td valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <th width="41%" height="25" align="left" valign="middle" bgcolor="#03617C" class="style2" scope="col">&nbsp;&nbsp;Website Management > View  Agents</th>
	  ...
	  <tr>
	 	<td height="22" colspan="2" align="right" valign="middle"><a href="web_product_add.php" class="style10"><font color="#FF0000">Add New Agent</font></a>&nbsp;</td>
	 </tr>
      <tr>
        <th height="22" colspan="2" class="style77" scope="col"><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td width="20%" align="center" valign="middle" bgcolor="#FFFFD5" class="style10">Name </td>
               <td width="10%" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Numbering</td>
			
            <td width="25%" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Email </td>
            <td width="25%" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Address</td>
           <!-- <td align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Category </td>-->
           <td width="25%" height="22" align="left" valign="middle" bgcolor="#FFFFD5" class="style10">Phone Number</td>
            <td width="25%" height="22" align="center" valign="middle" bgcolor="#FFFFD5" class="style10">Action</td>
          </tr>
          <?php 
		   ...
		   {			
            ...
            <tr>
			  ...
			  <!-- <td width="14%" align="left" valign="top" class="style77"><div style="margin:1px;"><?php echo $productRow['heading']?></div></td>-->
			   <!-- <td width="16%" align="left" valign="top" class="style77"><?php //echo $subsubRow['heading']; ?> <?php //if ($subsubRow['heading']=='') echo 'N/A';?></td>-->
				
				<td width="19%" align="center" valign="top" class="style77"><?php echo $productRow['Name'] ?> </td>
				<td width="9%" align="left" valign="top" class="style77">
			  	<?php echo $productRow['numbering'];?>			  </td> 
              <td width="18%" align="left" valign="top" class="style77"><span style="margin:1px;">
                ...
                <?php echo $productRow['Address']; ?>
                 ...
                 <td width="18%" align="left" valign="top" class="style77"><span style="margin:1px;">
                <?php echo $productRow['Phone']; ?>
              </span></td>
             
             
             
              
              <td align="center" valign="top" class="style77"><div style="margin:3px;"><a href="web_product_edit.php?id=<?php echo $productRow['id']?>">Edit</a>&nbsp;|&nbsp;<a href="web_product_delete.php?id=<?php echo $productRow['id']; ?>" onClick="return deleteAlert(this);">Delete</a></div></td>
            </tr>
          <tr>
      ...
      <tr>
        <th height="20" colspan="2" align="right" valign="top" class="style77" scope="col"><a href="web_product_add.php" class="style10"><font color="#FF0000">Add New Agent</font></a>&nbsp;</th>
      </tr>
    </table></td>
  </tr>
</table>
