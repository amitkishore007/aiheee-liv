...
{
    $c_id=$_POST['c_id'];
    $query = mysql_query("select * from coordinate where c_id = '$c_id '");
    $rows = mysql_fetch_array($query);
    $mobile_number= $rows['c_phone'];
    $s_id = $rows['s_id'];
                ...
                {
                 ?>
                        <script>alert('Please enter Correct mobile no!');</script>
                        <?php
                }
          ...
          <div class="card card-signup">
            ...
            <form class="form" method="POST" action="">
                ...
                <div class="form-group">
                  <input type="text" name="c_id" class="form-control underline-input" placeholder="Your Id">
                </div>
