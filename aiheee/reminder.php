            ...
            <div class="bg-light lter b-b wrapper-md mb-10">
                <div class="row">
                    <div class="col-sm-6 col-xs-12">
                        <h1 class="font-thin h3 m-0">Reminder</h1>
                    ...
                    <section class="boxs">
                        ...
                        <div class="boxs-body">
                            <form role="form">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label">Reminder Details:</label>
									<div class="col-sm-9">
										<div class="row">
											<div class="col-md-12">
                                ...
                                <button type="submit" class="btn btn-raised btn-primary">Add Reminder</button>
                            </form>
                        </div>
                    </section>
                </div>
