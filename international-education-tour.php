...
?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="breadcrumb-text">
                                    <h1 class="text-center">INTERNATIONAL EDUCATION TOURS</h1>
                                    <div class="breadcrumb-bar">
                                        <ul class="breadcrumb text-center">
                                            <li><a href="index.php">Home</a></li>
                                            <li>INTERNATIONAL EDUCATION TOURS</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
				...
				$userQuery = "select * from informative where informativeid='114' && status='active'";
